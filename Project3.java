...
{	Scanner sc=new Scanner(System.in);
	...
	void display()
	{
		...
		System.out.println("       **********");
		System.out.println("         ___ENERGY ZONE___");
		System.out.println("         _Contact:7207070905__");
		System.out.println("         _energyzone@gmail.com__");
		System.out.println("         __PALAMANER,CHITTOOR_");
		System.out.println("         ___517408____\n\n");
	}
	    ...
	    if(id==cid)
    	{
	        ...
	        {  
	            if(cage<=25)
	          {
                ...
                System.out.println(" ");
                System.out.println("It hurts now, but one day it will be your warm up");
                System.out.println();
	          }
	          else
	          {
...
public class Project3 
{
	...
	{   
		...
		do{
		    ...
		    System.out.println("                              -----------------");
		    System.out.println("              __Good things come to those who sweat__\n");
		    System.out.println("======================================*");
		    System.out.println("\n1.Display Details\n2.Display tools\n3.Registration\n4.Go and Workout\n5.Way out");
		    System.out.println("\nEnter your choice:");
		    ch=sc2.nextInt();
